...
使用MosDns作为默认的DNS解析(53)->AdGuardHome(5335 admin admin)->smartdns(530 admin password)->公共DNS<br>
请根据自己的需求自行修改<br>
使用openclash，请使用HTTP(S)&SOCKS5 混合代理端口（默认1092）<br>
---------------------------------------------------------------<br>
主要用于宽带多线路负载均衡mwan3自行配置 LAN默认NAT66模式
---------------------------------------------------------------<br>
默认登录 192.168.31.110
...
&nbsp;&nbsp;&nbsp;&nbsp;with:<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;node-version: ${{ matrix.version }}<br><br><br>

src/gz immortalwrt_base https://mirror.nju.edu.cn/immortalwrt/releases/24.10.0/packages/arm_cortex-a5_vfpv4/base<br>
src/gz immortalwrt_luci https://mirror.nju.edu.cn/immortalwrt/releases/24.10.0/packages/arm_cortex-a5_vfpv4/luci<br>
src/gz immortalwrt_packages https://mirror.nju.edu.cn/immortalwrt/releases/24.10.0/packages/arm_cortex-a5_vfpv4/packages<br>
src/gz immortalwrt_routing https://mirror.nju.edu.cn/immortalwrt/releases/24.10.0/packages/arm_cortex-a5_vfpv4/routing<br>
src/gz immortalwrt_telephony https://mirror.nju.edu.cn/immortalwrt/releases/24.10.0/packages/arm_cortex-a5_vfpv4/telephony<br>
